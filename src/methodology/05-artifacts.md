...
- **matplotlib styling consistent** with clear axis labels and legends
- **Wrong metadata** (dataset name, sample size) is a **Category A**
  review finding
...
**Intermediate data files** (`.npz`, `.json`, analysis artifacts (data files, model configs), trained
